                ...
                <form className="profile__form" onSubmit={handleSubmit} noValidate>
                    <fieldset id="fieldset" className="profile__fieldset" disabled>
                        <label className="profile__label">
                            Имя
                            <input type="text" name="name" id="name" className="profile__input" value={values.name || ''} onChange={handleChange} onInput={handleInput} required minLength="2" maxLength="30" />
                        </label>
                        <span id="error-name" className="profile__error"></span>
                        <label className="profile__label">
                            E-mail
                            <input type="email" name="email" id="email" className="profile__input" value={values.email || ''} onChange={handleChange} onInput={handleInput} required />
                        </label>
